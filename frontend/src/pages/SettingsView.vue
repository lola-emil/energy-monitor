                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            <div class="space-y-1">
                                ...
                                <div class="inline-flex rounded-md border bg-background p-0.5">
                                    <Button type="button" size="sm" variant="ghost" :class="form.default_analytics_range === 'today'
                                        ? 'bg-primary text-primary-foreground'
                                        : ''" @click="form.default_analytics_range = 'today'">
                                        Today
                                    </Button>
                                    <Button type="button" size="sm" variant="ghost" :class="form.default_analytics_range === '7d'
                                        ? 'bg-primary text-primary-foreground'
                                        : ''" @click="form.default_analytics_range = '7d'">
                                        Last 7 days
                                    </Button>
                                    <Button type="button" size="sm" variant="ghost" :class="form.default_analytics_range === 'month'
                                        ? 'bg-primary text-primary-foreground'
                                        : ''" @click="form.default_analytics_range = 'month'">
                                        This month
                                    </Button>
                                </div>
                                <p class="text-xs text-muted-foreground">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="flex items-center gap-2">
                                    <Input id="refresh-interval" v-model.number="form.refresh_interval_seconds"
                                        type="number" min="1" step="1" class="max-w-30" />
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="inline-flex rounded-md border bg-background p-0.5">
                                    <Button type="button" size="sm" variant="ghost" :class="form.time_format === '24h'
                                        ? 'bg-primary text-primary-foreground'
                                        : ''" @click="form.time_format = '24h'">
                                        24-hour
                                    </Button>
                                    <Button type="button" size="sm" variant="ghost" :class="form.time_format === '12h'
                                        ? 'bg-primary text-primary-foreground'
                                        : ''" @click="form.time_format = '12h'">
                                        12-hour
                                    </Button>
                                </div>
                                <p class="text-xs text-muted-foreground">
